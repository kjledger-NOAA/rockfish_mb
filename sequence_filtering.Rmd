...
UPDATE - NOT USING THIS SCRIPT IN FINAL DATA ANALYSIS - processed all sequences through dadasnake instead

note: added additional tissue sequences on 12.4.2024 and 12.31.2024 reran without removing the primer sequences from reads 
...
DADA2 processing of UNtrimmed reads (used cutadapt with --no-trim flag)
...
```{r}
path <- "/genetics/edna/workdir/sebastes/tissues/untrimmed_20241231/"
