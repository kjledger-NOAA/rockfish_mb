---
title: "filtering sequences for first rockfish primer test"
...
```{r}
path <- "/genetics/edna/workdir/sebastes/20240813/trimmed/"
...
#checking reads of sizes for gadidS1 
#seqtab2 <- seqtab[,nchar(colnames(seqtab)) %in% 225]
```
