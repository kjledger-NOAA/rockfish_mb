...
```{r}
rock <- read.table("/home/kimberly.ledger/rockfish_mb/data/blastn_custom519_20241106.txt")  %>%
...
```{r}
write.csv(rockfish_df_3, "/home/kimberly.ledger/rockfish_mb/data/taxonomy_custom519_20241106.csv")
```
