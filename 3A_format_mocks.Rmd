...
reformat and join the mock reads with expected mock values - for now using the v.534 version of tax assignment
```{r}
...
## the rest are just some exploratory plots 
```{r}
mock_table %>%
...
- ruberrimus is missing (tissue seqs for this were wacky) - they assigned to babcocki and pinniger. 
